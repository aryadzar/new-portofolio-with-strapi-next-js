  ...
  return (
    <div className="container px-10 lg:mx-auto my-20">
      <p className=" text-justify">
        ...
        data loads. Additionally, I focus on implementing clean, maintainable
        code that follows best practices, facilitating easier updates and
        long-term growth.
      </p>
          ...
          <div key={idx} className="text-white w-full md:w-1/2">
            ...
            <div className="space-y-6">
              {section.items.map((item, index) => (
                <div
                  key={index}
                  className="bg-purple-900 p-6 rounded-lg shadow-lg relative"
                >
                  {/* Timeline Dot */}
